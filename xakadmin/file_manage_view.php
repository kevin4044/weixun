...
else if($fmdo=="edit")
{
    ...
    $ctp = new XakTagParse();
    $ctp->LoadTemplate(XAKADMIN."/templets/file_edit.htm");
    $ctp->display();
}
/*编辑文件，可视化模式
else if($fmdo=="editview")
{
    ...
    $GLOBALS['filename'] = $filename;
    $ctp = new XakTagParse();
    $ctp->LoadTemplate(XAKADMIN."/templets/file_edit_view.htm");
    $ctp->display();
}
*/
//新建文件
...
{
    $ctp = new XakTagParse();
    $ctp->LoadTemplate(XAKADMIN."/templets/file_upload.htm");
    $ctp->display();
}