...
if($dopost=='')
{
    ...
    $totalRow = $row['dd'];
    include(XAKADMIN."/templets/freelist_main.htm");
}
...
function GetTagList($dsql,$pageno,$pagesize,$orderby='aid')
{
    ...
    $printhead ="<table width='98%' border='0' cellpadding='1' cellspacing='1' align='center'  class='tbtitle' style='background:#cfcfcf;margin-bottom:5px;'>
        <tr align='center' bgcolor='#F9FCFD'>
    ...
    while($row = $dsql->GetArray())
    {
        ...
        $line = "
    <tr align='center' bgcolor='#FFFFFF' onMouseMove=\"javascript:this.bgColor='#F9FCFD';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\">
        <td>{$row['aid']}</td>
