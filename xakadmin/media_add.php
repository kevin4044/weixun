...
if($dopost=="upload")
{
    ...
    $sparr_image = Array("image/pjpeg","image/jpeg","image/gif","image/png","image/x-png","image/xpng","image/wbmp");
...
include XAKINClude('templets/media_add.htm');