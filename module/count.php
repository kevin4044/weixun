 ...
 * <script src="{xak:field name='phpurl'/}/count.php?view=yes&aid={xak:field name='id'/}&mid={xak:field name='mid'/}" language="javascript"></script>
 * 普通计数器为
 * <script src="{xak:field name='phpurl'/}/count.php?aid={xak:field name='id'/}&mid={xak:field name='mid'/}" language="javascript"></script>
 *
