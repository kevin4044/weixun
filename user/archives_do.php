...
{
    CheckRank(0,0);
    include_once(XAKMEMBER."/inc/inc_batchup.php");
    ...
    if($rs)
    {
        ...
        //扣除积分
        $dsql->ExecuteNoneQuery("Update `#@__member_list` set scores=scores-{$cfg_sendarc_scores} where mid='".$cfg_ml->M_ID."' And (scores-{$cfg_sendarc_scores}) > 0; ");
