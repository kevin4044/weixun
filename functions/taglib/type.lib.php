...
function lib_type(&$ctag,&$refObj)
{
  ...
  if(empty($typeid)) return '';
    ...
    $row = $dsql->GetOne("SELECT id,typename,typedir,seotitle,content,typepic,open_new,description,isdefault,ispart,defaultname,namerule2,moresite,siteurl,sitepath 
