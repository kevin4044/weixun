...
if(file_exists(XAKDATA.'/template.rand.php'))
{
    require_once(XAKDATA.'/template.rand.php');
}
...
if($dopost!='save')
{
    ...
    {
        require_once(XAKADMIN."/inc/inc_coonepage.php");
    ...
    include XAKINClude("templets/article_add.htm");
    exit();
}
