 ...
 * 投票类
 *
 * @version        $Id: xakvote.class.php 1 10:31 2010年7月6日
 */
...
class XakVote
{
     ...
     * @return    string
     */
    function GetVoteForm($lineheight=30,$tablewidth="100%",$titlebgcolor="#333",$titlebackgroup="",$tablebg="#FFFFFF",$itembgcolor="#FFFFFF")
    {
        //省略参数
        if($lineheight=="")
        {
