...
function lib_arclist( &$ctag, &$refObj )
{
	...
	$istypeid2 = trim($ctag->GetAtt('istypeid2'));
    ...
    return lib_arclistDone
           (
             ...
             $tagid,$pagesize,$isweight,$istypeid2
           );
}
 ...
 * @param     string  $istypeid2  是否需要调取副栏目文章
 * @return    string
 */
function lib_arclistDone(&$refObj, &$ctag, $typeid=0, $row=10, $col=1, $titlelen=30, $infolen=160,
        $imgwidth=120, $imgheight=90, $listtype='all', $orderby='default', $keyword='',
        $innertext='', $arcid=0, $idlist='', $channelid=0, $limit='', $att='', $order='desc', $subday=0, $noflag='',$tagid='', $pagesize=0, $isweight='N',$istypeid2=0)
{
            ...
            else
            {
				...
				if($istypeid2)
				{
					...
					if($CrossID!='')
					{
						...
						$typeids = array_merge($typeids,$crossids);
					}
	...
	else if($orderby == 'weight') $ordersql = "  ORDER BY arc.weight DESC,arc.id DESC";
