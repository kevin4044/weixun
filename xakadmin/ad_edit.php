...
else if($dopost=="gettag")
{
    ...
    $showtag = '{'."xak:myad name='{$row['tagname']}'/".'}';
    $info = "<b>说明：</b>如果嵌入的是CMS广告标签，那么将会解析成标签中的内容到页面，广告更改后需要重新生成。<br />
...
include XAKINClude('templets/ad_edit.htm');