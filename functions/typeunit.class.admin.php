...
class TypeUnit
{
    ...
    function ListAllType($channel=0,$nowdir=0)
    {
        ...
        while($row = $this->dsql->GetObject(0))
        {
            ...
            {
                echo "  <tr>\r\n";
                echo "  <td style='background-color:#FBFCE2;' width='2%' class='bline'><img style='cursor:pointer' id='img".$id."' onClick=\"LoadSuns('suns".$id."',$id);\" src='images/explode.gif' width='11' height='11'></td>\r\n";
            ...
            else if($ispart==2)
            {
                ...
                echo "  <td width='2%' class='bline2'><img style='cursor:pointer' id='img".$id."' onClick=\"LoadSuns('suns".$id."',$id);\" src='images/explode.gif' width='11' height='11'></td>\r\n";
