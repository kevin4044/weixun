...
class diyform
{
    ...
    function __construct($diyid){
        ...
        $this->listTemplate = $diyinfo['listtemplate'] != '' && file_exists(XAKTEMPLATE.'/module/'.$diyinfo['listtemplate']) ? $diyinfo['listtemplate'] : 'list_diyform.htm';
        $this->viewTemplate = $diyinfo['viewtemplate'] != '' && file_exists(XAKTEMPLATE.'/module/'.$diyinfo['viewtemplate']) ? $diyinfo['viewtemplate'] : 'view_diyform.htm';;
        $this->postTemplate = $diyinfo['posttemplate'] != '' && file_exists(XAKTEMPLATE.'/module/'.$diyinfo['posttemplate']) ? $diyinfo['posttemplate'] : 'post_diyform.htm';;
    }
    ...
    function getForm($type = 'post', $value = '', $admintype='diy')
    {
        ...
        $formstring .= "<input type=\"hidden\" name=\"xak_fields\" value=\"".$formfields."\" />\n";
        $formstring .= "<input type=\"hidden\" name=\"xak_fieldshash\" value=\"".md5($formfields.$cfg_cookie_encode)."\" />";
        return $formstring;
    }
