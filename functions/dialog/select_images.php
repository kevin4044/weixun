...
<title>图片浏览器</title>
<link href='../../module/img/base.css' rel='stylesheet' type='text/css'>
<style>
...
<?php $noeditor = !empty($noeditor)?"<input type='hidden' name='noeditor' value='yes'>":''; echo $noeditor;//（2011.08.25 根据用户反馈修正图片上传回调 by:的鱼）?>
