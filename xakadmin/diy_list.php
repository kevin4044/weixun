...
require_once XAKINC.'/diyform.cls.php';
...
if($action == 'post')
{
    if(empty($do))
    {
        ...
        include XAKADMIN.'/templets/diy_post.htm';
    }
    else if($do == 2)
    {
...
} else if ($action == 'list')
{
    ...
    $datalist->SetTemplate(XAKADMIN.'/templets/diy_list.htm');
...
} else if ($action == 'edit')
{
    if(empty($do))
    {
        ...
        include XAKADMIN.'/templets/diy_edit_content.htm';
    }
    else if($do == 2)
    {
        $xak_fields = empty($xak_fields) ? '' : trim($xak_fields);
