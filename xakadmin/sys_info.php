...
else if ($dopost=='search')
{
 ...
 <table width="100%" cellspacing="1" cellpadding="1" border="0" bgcolor="#cfcfcf" id="tdSearch" style="">
  <tbody>
   <tr height="25" bgcolor="#F9FCFD" align="center">
...
?>
    ...
    if ($i == 1)
    {
        echo '<tr align="center" bgcolor="#F9FCFD" height="25"><td colspan="3">没有找到搜索的内容</td></tr></table>';
    }
    exit;
}
include XAKINClude('templets/sys_info.htm');