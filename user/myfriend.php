...
if($dopost=='upsta')
{
    ...
    #api{{
    if(defined('UC_API') && @include_once XAKROOT.'/uc_client/client.php' && $sta!='bad')
    {
...
{
    global $dsql;
    $row = $dsql->GetOne("SELECT M.*,YEAR(CURDATE())-YEAR(P.birthday) as age,DATE_FORMAT(P.birthday,'%e月%d日出生') as birthday,S.spacename,S.sign FROM `#@__member_list` AS M 
