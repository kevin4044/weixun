...
$ImageWaterConfigFile = XAKDATA."/mark/inc_photowatermark_config.php";
...
if($action=="save")
{
    ...
    if(is_uploaded_file($newimg))
    {
        ...
        @move_uploaded_file($newimg,XAKDATA."/mark/".$photo_markimg);
    }
...
include XAKINClude('templets/sys_info_mark.htm');