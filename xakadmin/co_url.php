...
if($nid!='')
{
    ...
    onClick=\"location.href='co_export.php?nid=$nid';\" />
    <input type='button' name='b0' value='采集本节点' class='coolbg np'
    onClick=\"location.href='co_gather_start.php?nid=$nid';\" />
    ";
}
else
{
...
if($small==0)
{
    $dlist->SetTemplate(XAKADMIN."/templets/co_url.htm");
}
else
{
    $dlist->SetTemplate(XAKADMIN."/templets/co_url_2.htm");
}
$dlist->SetSource($sql);
$dlist->display();
