...
require_once(XAKADMIN.'/inc/inc_batchup.php');
...
else if($dopost=="viewArchives")
{
    ...
    if($trow['issystem'] != -1)
    {
		...
		PutCookie('XakUserID',$arcRow['mid'],1800);
...
<tr height='32'>
    ...
    <td class='bline'>
        <input name="keywords" type="text" id="keywords" value="<?php echo $arcRow['keywords']; ?>" style="width:90%" />
    </td>
</tr>
<tr height='32'>
    <td colspan='2' align='center' style='padding-top:12px'>
        ...
        &nbsp;&nbsp;
        <img src="images/button_back.gif" border="0" onclick='HideObj("<?php echo $divname; ?>");ChangeFullDiv("hide");' style="cursor:pointer" />
    </td>
</td>
</tr>
</table>
...
{
    require_once(XAKINC.'/typeunit.class.selector.php');
    AjaxHead();
    //输出AJAX可移动窗体
    $divname = 'getCatMap';
