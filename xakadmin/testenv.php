 ...
 * 系统目录权限检测与修正
 *
 * @version        $Id: testenv.php 1 23:44 2010年7月20日Z 
 */
...
$cfg_cmspath/config|
$cfg_cmspath/config/$cfg_backup_dir|
$cfg_cmspath/config/textdata|
$cfg_cmspath/config/sessions|
$cfg_cmspath/config/tplcache|
$cfg_cmspath/config/admin|
$cfg_cmspath/config/enums|
$cfg_cmspath/config/mark|
$cfg_cmspath/config/module|
$cfg_cmspath/config/rss";
?>
<html>
<head>
...
if($action=='')
{
    ...
    echo "（如果您的主机使用的是windows系统，您无需进行此操作）";
