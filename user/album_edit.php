...
if(empty($dopost))
{
    ...
    include(XAKMEMBER."/templets/album_edit.htm");
    exit();
}
/*------------------------------
function _Save(){  }
...
else if($dopost=='save')
{
    ...
    include(XAKMEMBER.'/inc/archives_check_edit.php');
    $imgurls = "{xak:pagestyle maxwidth='$maxwidth' pagepicnum='$pagepicnum'
	...
	$description = HtmlReplace($description, -1);//2011.06.30 增加html过滤 （by:的鱼）
    //处理图片文档的自定义属性
    if($litpic!='') $flag = 'p';
