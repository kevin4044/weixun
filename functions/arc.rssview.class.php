...
class RssView
{
    ...
    function __construct($typeid,$max_row=50)
    {
        ...
        $templetfiles = $GLOBALS['cfg_basedir'].$GLOBALS['cfg_templets_dir']."/module/rss.htm";
    ...
    function MakeRss($isremote=0)
    {
        ...
        $murl = $GLOBALS['cfg_cmspath']."/config/rss/".$this->TypeID.".xml";
    ...
    function GetArcList($innertext="")
    {
        ...
        while($row = $this->dsql->GetArray('al'))
        {
            ...
            // 2011-6-20 启用多站点RSS输出存在的路径问题(by:的鱼)
