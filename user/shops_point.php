...
if(isset($oid))
{
    ...
    $members = $dsql->GetOne("SELECT `money` FROM `#@__member_list` WHERE mid='".$cfg_ml->M_ID."'");
    ...
    {
        $res = $dsql->ExecuteNoneQuery("UPDATE `#@__member_list` SET money=money-$priceCount WHERE mid='{$cfg_ml->M_ID}'");
